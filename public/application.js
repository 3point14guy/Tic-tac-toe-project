...
/***/ (function(module, exports, __webpack_require__) {
	...
	var events = __webpack_require__(8); // allows us to use functions from other files
	...
	var gameOver = false; // to pass to gameUpdate ajax
	var clickCounter = 1;
	var position = void 0; // to pass to gameUpdate ajax
	var letter = 'x'; // to pass to gameUpdate ajax
	$(function () {
	  ...
	  $('.squares').on('click', function (event) {
	    ...
	    if ($(event.target).text() === 'x' || $(event.target).text() === 'o') {
	      ...
	      // if counter is even, O is played
	      $(event.target).text('o');
	      letter = 'o';
	      position = $(event.target).data('id');
	...
	$(function () {
	  var resetSquares = $('.squares').text(); // linter says no-unused-vars, but it is used
	...
	$(function () {
	  $('.squares').on('click', function (event) {
	    ...
	    if ($('.square-one').text() === $('.square-two').text() && $('.square-one').text() === $('.square-three').text() && $('.square-one').text() !== '' || $('.square-four').text() === $('.square-five').text() && $('.square-four').text() === $('.square-six').text() && $('.square-four').text() !== '' || $('.square-seven').text() === $('.square-eight').text() && $('.square-seven').text() === $('.square-nine').text() && $('.square-seven').text() !== '' || $('.square-one').text() === $('.square-four').text() && $('.square-one').text() === $('.square-seven').text() && $('.square-one').text() !== '' || $('.square-two').text() === $('.square-five').text() && $('.square-two').text() === $('.square-eight').text() && $('.square-two').text() !== '' || $('.square-three').text() === $('.square-six').text() && $('.square-three').text() === $('.square-nine').text() && $('.square-three').text() !== '' || $('.square-one').text() === $('.square-five').text() && $('.square-one').text() === $('.square-nine').text() && $('.square-one').text() !== '' || $('.square-three').text() === $('.square-five').text() && $('.square-three').text() === $('.square-seven').text() && $('.square-three').text() !== '') {
	      $('.game-board').hide();
	      $('.win-view-x').show();
	      gameOver = true;
	      var clickCount = clickCounter - 1;
	...
	var updateGame = function updateGame() {
	  ...
	  logGameMoves(data).then(updateGameSuccess).catch(updateGameFailure);
	};
	...
	var logGameMoves = function logGameMoves(data) {
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://powerful-scrubland-54674.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  // console.log(data)
	  event.preventDefault();
	  api.signUp(data).then(ui.signUpSuccess) // defines what to do on success
	...
	var createAGame = function createAGame(event) {
	  event.preventDefault();
	  api.createGame().then(ui.createGameSuccess).catch(ui.createGameFailure);
	};

	var displayStats = function displayStats(event) {
	  console.log('gonna get stats now');
	  api.getStats().then(ui.displayStatsSuccess).catch(ui.displayStatsFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var displayStatsSuccess = function displayStatsSuccess(data) {
	  // store.game = data.game
	...
	var displayStatsFailure = function displayStatsFailure(data) {
	...
	module.exports = {
	  displayStatsSuccess: displayStatsSuccess,
	  displayStatsFailure: displayStatsFailure,
